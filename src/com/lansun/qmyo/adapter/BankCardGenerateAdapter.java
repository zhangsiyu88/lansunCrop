...
import com.lansun.qmyo.adapter.BankCardGenerateAdapter.ViewHolder;
...
public class BankCardGenerateAdapter extends
	...
	public BankCardGenerateAdapter(ListView listView,
	...
	public BankCardGenerateAdapter(ListView listView,ArrayList<HashMap<String, String>> dataList,
					...
					DialogUtil.createTipAlertDialog(context,R.string.add_bankCard,
							new TipAlertDialogCallBack() {
								...
								public void onPositiveButtonClick(
									...
									FastHttpHander.ajax(GlobalValue.URL_BANKCARD_ADD,params, config,BankCardGenerateAdapter.this);
...
//							v.iv_top_card.setVisibility(View.GONE);
					...
					DialogUtil.createTipAlertDialog(context,R.string.add_bankCard,new TipAlertDialogCallBack() {
								...
								public void onPositiveButtonClick(DialogInterface dialog, int which) {
									...
									FastHttpHander.ajax(GlobalValue.URL_AUTH_TEMPORARY, config, BankCardGenerateAdapter.this);
									Handler_Inject.injectFragment(BankCardGenerateAdapter.this, null);
									dialog.dismiss();
								}
