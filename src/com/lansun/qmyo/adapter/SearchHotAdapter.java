...
import com.lansun.qmyo.adapter.SearchHotAdapter.ViewHolder;

public class SearchHotAdapter extends LazyAdapter<HashMap<String, String>, ViewHolder>  {
	
	public SearchHotAdapter(GridView listView,ArrayList<HashMap<String, String>> dataList, int layout_id) {
