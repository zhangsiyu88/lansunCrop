...
import com.lansun.qmyo.adapter.FeedBackAdapter.ViewHolder;

public class FeedBackAdapter extends LazyAdapter<HashMap<String, String>, ViewHolder> {

	public FeedBackAdapter(ListView listView,ArrayList<HashMap<String, String>> dataList, int layout_id) {
