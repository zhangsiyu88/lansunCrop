...
public class CityListAdapter extends BaseAdapter implements SectionIndexer{
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) { 
			...
			viewHolder.city_all_title = (RelativeLayout) view.findViewById(R.id.city_all_title);
		...
		if(position == getPositionForSection(section)){
			...
			viewHolder.city_all_title.setVisibility(View.VISIBLE);
			viewHolder.cityLetter.setText(city.getFirstLetter());
		}else{
			viewHolder.cityLetter.setVisibility(View.GONE);
			viewHolder.city_all_title.setVisibility(View.GONE);
		}
	...
	final static class ViewHolder {
		public RelativeLayout city_all_title;
		TextView cityLetter;
		TextView cityName;
	}
