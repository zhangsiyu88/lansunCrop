...
public class SecretaryShoppingShowFragment extends SecretaryDetailsBaseFragment implements ExecutInitData{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view=inflater.inflate(R.layout.secretary_shopping_fragment,container,false);
		initView(view);
		initData();
		setListener();
	...
	private void setListener() {
				...
				if (isExperience()) {
					...
					window.findViewById(R.id.btn_login).setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							bundle.putString("fragment_name", SecretaryShoppingShowFragment.class.getSimpleName());
		...
		check_suprice.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				View view=inflater.inflate(R.layout.shopping_dialog, null);	
				final AlertDialog dialog=new AlertDialog.Builder(getActivity()).create();
				dialog.setView(view);
				dialog.setCancelable(true);
				dialog.show();
				view.findViewById(R.id.shopping).setOnClickListener(new OnClickListener() {
					@Override
					public void onClick(View v) {
						dialog.dismiss();
					}
