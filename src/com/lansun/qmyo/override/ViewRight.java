package com.lansun.qmyo.override;
...
public class ViewRight extends RelativeLayout implements ViewBaseAction{
	...
	private void init(Context context) {
		...
		setBackgroundDrawable(getResources().getDrawable(R.drawable.choose_item_selected));
		mListView = (ListView) findViewById(R.id.listView);
		adapter = new TextAdapter(context, items, R.drawable.choose_item_selected, R.drawable.choose_item_selected);
