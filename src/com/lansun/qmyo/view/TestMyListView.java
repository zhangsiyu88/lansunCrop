...
public class TestMyListView extends ListView  {//implements OnScrollListener
...
//		mGestureDetector = new GestureDetector(new YScrollDetector());
	...
	public TestMyListView(Context context, AttributeSet attrs) {
		super(context, attrs);
//		mGestureDetector = new GestureDetector(new YScrollDetector());
		setFadingEdgeLength(0);
		initHeader();
	...
	public TestMyListView(Context context, AttributeSet attrs, int defStyle) {
