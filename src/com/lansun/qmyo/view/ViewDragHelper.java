...
//	private static final int EDGE_SIZE = 100; // dp
...
//	private static final int MAX_SETTLE_DURATION = 600; // ms
	 ...
	 *            true if state callbacks should be deferred via posted message. Set this to true if you are calling this method from {@link android.view.View#computeScroll()} or similar methods invoked as part of layout or drawing.
	...
	public void processTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE: {
			if (mDragState == STATE_DRAGGING) {
				...
				mActivePointerId = mActivePointerId==-1?0:mActivePointerId;
	 ...
	 * 
	 * @param edges
	 *            Edges to check for an initial edge touch. See {@link #EDGE_LEFT}, {@link #EDGE_TOP}, {@link #EDGE_RIGHT}, {@link #EDGE_BOTTOM} and {@link #EDGE_ALL}
