...
public class BankcardListView extends ListView  {//implements OnScrollListener
...
//		mGestureDetector = new GestureDetector(new YScrollDetector());
	...
	public BankcardListView(Context context,boolean isNoHaeader) {
		super(context);
//		mGestureDetector = new GestureDetector(new YScrollDetector());
		setFadingEdgeLength(0);
		//initHeader();
...
//		mGestureDetector = new GestureDetector(new YScrollDetector());
	...
	public BankcardListView(Context context, AttributeSet attrs, int defStyle) {
