...
public class HomeMyListView extends ListView  {//implements OnScrollListener
...
//		mGestureDetector = new GestureDetector(new YScrollDetector());
	...
	public HomeMyListView(Context context,boolean isNoHaeader) {
		super(context);
//		mGestureDetector = new GestureDetector(new YScrollDetector());
		setFadingEdgeLength(0);
		initHeader();
	...
	public HomeMyListView(Context context, AttributeSet attrs) {
		super(context, attrs);
//		mGestureDetector = new GestureDetector(new YScrollDetector());
		setFadingEdgeLength(0);
		initHeader();
	...
	public HomeMyListView(Context context, AttributeSet attrs, int defStyle) {
