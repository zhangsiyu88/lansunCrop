...
import android.widget.TextView;
	 ...
	 * @version 1.00
	 */ 
	public class RubbleTextView extends TextView { 
	    ...
	    public RubbleTextView(Context context, AttributeSet attrs, int defStyle) { 
	    ...
	    public RubbleTextView(Context context, AttributeSet attrs) { 
	        super(context, attrs); 
	        // bgColor = 
	        // attrs.getAttributeIntValue("http://schemas.android.com/apk/res/android", 
	        // "textColor", 0xFFFFFF); 
