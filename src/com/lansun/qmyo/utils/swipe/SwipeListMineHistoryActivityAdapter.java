 ...
 * 
 */
public class SwipeListMineHistoryActivityAdapter extends BaseAdapter {
	...
	public SwipeListMineHistoryActivityAdapter(Context ctx , ArrayList<HashMap<String, String>> dataList){
	...
	public SwipeListMineHistoryActivityAdapter(Activity activity,ArrayList<HashMap<String, Object>> activityDataList) {
